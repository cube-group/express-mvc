...
<body>
	...
	<div id="logo"><a href="http://www.raintpl.com"><img src="view/img/logo.gif"></a></div>
	...
	<div id="content">
		...
		<div class="layout">
			...
			<tt>
			<ul>
			<?php $counter1=-1; if( !is_null($week) && is_array($week) && sizeof($week) ) foreach( $week as $key1 => $value1 ){ $counter1++; ?>
			...
			<ul>
				...
				<?php $counter1=-1; if( !is_null($user) && is_array($user) && sizeof($user) ) foreach( $user as $key1 => $value1 ){ $counter1++; ?>
			...
			<tt>
			<ul>
				<?php $counter1=-1; if( !is_null($empty_array) && is_array($empty_array) && sizeof($empty_array) ) foreach( $empty_array as $key1 => $value1 ){ $counter1++; ?>
		...
		<div class="layout">
			...
			<tt><?php $tpl = new modules\engine\raintpl\RainTPL;$tpl->assign( $this->var );$tpl->draw( "test" );?></tt>
		</div>
		...
		<div class="layout">
			...
			<img src="view/img/logo.gif" alt="logo"/>
			<br/><br/><br/>
